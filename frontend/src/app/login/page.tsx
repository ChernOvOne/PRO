  ...
  useEffect(() => {
    ...
    window.onTelegramAuth = async (tgUser: any) => {
      ...
      try {
        ...
        // router.push иногда не подхватывает куку сразу после логина
    ...
    if (!botName) {
      console.warn('NEXT_PUBLIC_TG_BOT_NAME не задан — Telegram-виджет не загружен')
      return
    }
    ...
    // data-auth-url — страница на которой стоит виджет.
    // Telegram проверяет что этот домен совпадает с доменом в Bot Settings.
